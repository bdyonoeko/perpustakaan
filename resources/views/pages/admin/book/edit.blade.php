...
<div class="container-fluid">
    ...
    <div class="card shadow-sm">
        <div class="container py-4">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Ubah Buku</h1>
                ...
                <form action="{{ route('book.update', $book->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('publisher') is-invalid @enderror" id="publisher"
                            name="publisher" placeholder="Ex: Bentang Pustaka"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('year') is-invalid @enderror" id="year"
                            name="year" placeholder="Ex: 2005" value="{{ old('year') ? old('year') : $book->year }}">
                        @error('year')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('stock') is-invalid @enderror" id="stock"
                            name="stock" placeholder="Ex: 10" value="{{ old('stock') ? old('stock') : $book->stock }}">
                        @error('stock')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
